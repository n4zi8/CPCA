...
namespace CPCA
{
    partial class FrmRVERS
    {
        ...
        {
            DGVRVERS = new DataGridView();
            rcode = new DataGridViewTextBoxColumn();
            rold_ratio_share = new DataGridViewTextBoxColumn();
            rnew_ratio_share = new DataGridViewTextBoxColumn();
            rnew_par_value = new DataGridViewTextBoxColumn();
            rtrade_dt = new DataGridViewTextBoxColumn();
            rrecord_dt = new DataGridViewTextBoxColumn();
            rshare = new DataGridViewTextBoxColumn();
            rremark = new DataGridViewTextBoxColumn();
            ...
            ((System.ComponentModel.ISupportInitialize)DGVRVERS).BeginInit();
            toolStrip1.SuspendLayout();
            SuspendLayout();
            // 
            // DGVRVERS
            // 
            DGVRVERS.AllowUserToAddRows = false;
            DGVRVERS.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            DGVRVERS.BackgroundColor = Color.AliceBlue;
            DGVRVERS.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            DGVRVERS.Columns.AddRange(new DataGridViewColumn[] { rcode, rold_ratio_share, rnew_ratio_share, rnew_par_value, rtrade_dt, rrecord_dt, rshare, rremark, rcreated_date, rrevised_date });
            DGVRVERS.Location = new Point(12, 123);
            DGVRVERS.Name = "DGVRVERS";
            DGVRVERS.RowTemplate.Height = 25;
            DGVRVERS.Size = new Size(776, 403);
            DGVRVERS.TabIndex = 0;
            // 
            // rcode
            // 
            ...
            // rold_ratio_share
            // 
            rold_ratio_share.HeaderText = "old_ratio_share";
            rold_ratio_share.Name = "rold_ratio_share";
            // 
            // rnew_ratio_share
            // 
            rnew_ratio_share.HeaderText = "new_ratio_share";
            rnew_ratio_share.Name = "rnew_ratio_share";
            // 
            // rnew_par_value
            // 
            rnew_par_value.HeaderText = "new_par_value";
            rnew_par_value.Name = "rnew_par_value";
            // 
            // rtrade_dt
            // 
            rtrade_dt.HeaderText = "trade_dt";
            rtrade_dt.Name = "rtrade_dt";
            // 
            // rrecord_dt
            // 
            rrecord_dt.HeaderText = "record_dt";
            rrecord_dt.Name = "rrecord_dt";
            // 
            // rshare
            // 
            rshare.HeaderText = "share";
            rshare.Name = "rshare";
            // 
            // rremark
            // 
            rremark.HeaderText = "remark";
            rremark.Name = "rremark";
            // 
            // rcreated_date
            // 
            ...
            Controls.Add(DGVRVERS);
            Name = "FrmRVERS";
            StartPosition = FormStartPosition.CenterParent;
            Text = "RVERS";
            ((System.ComponentModel.ISupportInitialize)DGVRVERS).EndInit();
